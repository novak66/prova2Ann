...
Suponha que C=0.3634farads, R=1.1559ohm, L=1.5608henrie e que a tensão seja dada por
E(t)=e−0.0644πtsin(2t−π).
Se i(t0)=i0, com t0=0 e i0=0, use o método de Heun para encontrar estimativas para a corrente i nos pontos tk=t0+kh, onde k=1,2,…,150 e h=0.176.
Figura 1: Estimativa para a corrente i no intervalo t∈[0,26.4] obtida pelo método de Heun."""
