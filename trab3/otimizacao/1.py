...
que melhor se aproxima da função f(x)=2sin(x)+cos(−x2) no intervalo [a,b], com a=−0.83264 e b=2.42387. Para o cálculo dos coeficientes ck, use a regra dos trapézios com 256 subintervalos. Em seguida calcule g(x) para os seguintes valores de x
x1=−0.57861, x2=0.8177 e x3=1.58703.
A função g(x) é uma aproximação para a função f(x) no intervalo [−0.83264,2.42387] com erro dado por
erro=∫2.42387−0.83264[f(x)−g(x)]2dx.
