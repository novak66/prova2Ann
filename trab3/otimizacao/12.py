...
Tn(x)=cos(n⋅arccos(x)).
Seja
g(x)=c0T0(x)+c1T1(x)+c2T2(x)+⋯+c9T9(x)
uma combinação linear dos 10 primeiros polinômios de Chebyshev. Encontre os coeficientes c0,c1,…,c9 tal que g(x) se aproxime o melhor possível da função f(x)=xcos(10x2e−x2) no intervalo [−1,1]. Para o cálculo dos coeficientes ck, use a regra de Simpson com 4096 subintervalos. Em seguida calcule g(x) para os seguintes valores de x
x1=−0.902, x2=−0.047 e x3=0.554.
