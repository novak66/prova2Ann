"""Seja V o espaço vetorial das funções contínuas definidas no intervalo [−1.338,1.237] com produto escalar definido por
⟨f,g⟩w=∫1.237−1.338w(x)f(x)g(x)dx,
onde f,g∈V e w(x)=1. Calcule o produto escalar ⟨f1,f2⟩w das funções f1,f2∈V definidas por
f1(x)=x2, f2(x)=cos(3x).
Para o cálculo das integrais, use a regra dos trapézios com 256 subintervalos."""
