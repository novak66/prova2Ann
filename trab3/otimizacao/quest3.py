...
que melhor se aproxima da função f(x)=x2cos(xsin(ln(1+x2))) no intervalo [a,b], com a=−2.15494 e b=2.03759. Para o cálculo dos coeficientes ck, use o método de Romberg com h=(b−a)/10 e erro da ordem de O(h8). Em seguida calcule g(x) para os seguintes valores de x
x1=−1.00544, x2=0.44253 e x3=1.81125.
A função g(x) é uma aproximação para a função f(x) no intervalo [−2.15494,2.03759] com erro dado por
erro=∫2.03759−2.15494[f(x)−g(x)]2dx.
...
if __name__ == '__main__':
    ...
    a = -2.15494
    b = 2.03759
    values = [-1.00544, 0.44253 , 1.81125]
    order = 8
    h = (b - (a)) / 10
